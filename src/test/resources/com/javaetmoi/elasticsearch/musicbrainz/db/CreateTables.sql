...
(
    ...
    notification_timeframe VARCHAR NOT NULL DEFAULT '1 week',
...
CREATE TABLE release_meta ( -- replicate (verbose)
    ...
    cover_art_presence  VARCHAR NOT NULL DEFAULT 'absent'
);
